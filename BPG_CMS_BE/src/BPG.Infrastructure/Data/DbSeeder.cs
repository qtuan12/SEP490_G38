...
- Cho phép chuyển sang triển khai công đoạn tiếp theo.",
        ...
        Random rnd)
    {
        ...
        var po2 = new PurchaseOrder
        {
            ...
            PONumber             = $"PO-WAIT-P{project.ProjectId:D3}-PH{phase.PhaseId:D3}",
        ...
        var po2SecondSupplier = new PurchaseOrder
        {
            ...
            PONumber = $"PO-SPLIT-P{project.ProjectId:D3}-PH{phase.PhaseId:D3}",
        ...
        var po3 = new PurchaseOrder
        {
            ...
            PONumber             = $"PO-PARTIAL-P{project.ProjectId:D3}-PH{phase.PhaseId:D3}",
