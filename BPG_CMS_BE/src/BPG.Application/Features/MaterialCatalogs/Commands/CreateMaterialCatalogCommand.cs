...
public record CreateMaterialCatalogCommand(
    long CategoryId,
    int BaseUnitId,
    string Code,
    string Name,
...
public class CreateMaterialCatalogCommandValidator : AbstractValidator<CreateMaterialCatalogCommand>
{
    public CreateMaterialCatalogCommandValidator()
    {
        RuleFor(v => v.Code)
